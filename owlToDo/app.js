...
class Task extends Component {
    ...
    justify-content-between border p-3 mb-2 rounded">
        ...
        <div t-if="!state.isEditing" class="form-check form-switch fs-5">
            <input class="form-check-input" type="checkbox" value="" t-att-checked="state.isCompleted" 
            t-att-id="state.id" t-on-click="toggleTask" t-model="state.isCompleted"/>
    ...
    static props = ["task", "deleteTask", "onEdit"]
...
class Root extends Component {
    ...
    <div>
        <div class="input-group-lg w-100 d-flex border rounded align-items-center">
            ...
            <button class="btn btn-primary" type="button" id="button-addon2" t-on-click="addTask"><i class="bi bi-plus-lg
            fs-3"></i></button>
        </div>
    </div>
